...
- It has different code structure, that aims at reduction of rarely used or unnecessary functions and some standartization.
- Using regex instead of full HTML parsing for extra speed (and arrays instead of objects as result). It does not mean, that this will alway be faster than using Symphony-based functions, but will be true on average.
- More filters for your search queries.
- Return more potentially useful information where possible.
- Attempt at multilangual support. Some filters even support actual "names" used on Lodestone (instead of just IDs).
...
<table>
	...
	<tr>
		...
		<td>Returns rankging of respective Deep Dungeon.</td>
	</tr>
	<tr>
